...
export const product = defineType({
  ...
  fields: [
    ...
    defineField({ name: "priceOriginal", title: "Van-prijs (€)", type: "number", group: "deal" }),
    defineField({ name: "savings", title: "Gem. besparing (€)", type: "number", group: "deal", initialValue: 0 }),
