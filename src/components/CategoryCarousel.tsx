...
function CategoryCard({ c }: { c: (typeof categories)[number] }) {
  return (
    <div className="w-72 shrink-0 snap-start overflow-hidden rounded-xl border border-line bg-white text-charcoal shadow-sm">
      <div className="relative aspect-square bg-panel-featured">
        {c.image ? (
